...
public open class fhirpathParser(input: TokenStream) : Parser(input) {
    private companion object {
        ...
        private val RULE_NAMES: Array<String> = arrayOf(
            "expression", "term", "literal", "externalConstant", "invocation", 
            "function", "paramList", "quantity", "unit", "dateTimePrecision", 
        ...
        private val LITERAL_NAMES: Array<String?> = arrayOf(
            ...
            "'hour'", "'minute'", "'second'", "'millisecond'", "'years'", 
        ...
        private val SYMBOLIC_NAMES: Array<String?> = arrayOf(
            ...
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, null, null, null, null, null, 
            null, null, null, null, null, "DATE", "DATETIME", "TIME", "IDENTIFIER", 
    ...
    public open class TypeExpressionContext : ExpressionContext {
        public fun expression(): ExpressionContext = getRuleContext(ExpressionContext::class, 0)!!
        public fun typeSpecifier(): TypeSpecifierContext = getRuleContext(TypeSpecifierContext::class, 0)!!
    ...
    private fun expression(_p: Int): ExpressionContext {
        ...
        try {
            ...
            when (_input.LA(1)) {
                Tokens.T__10, Tokens.T__11, Tokens.T__21, Tokens.T__22, Tokens.T__27, Tokens.T__29, Tokens.T__31, Tokens.T__32, Tokens.T__33, Tokens.T__34, Tokens.T__35, Tokens.T__36, Tokens.DATE, Tokens.DATETIME, Tokens.TIME, Tokens.IDENTIFIER, Tokens.DELIMITEDIDENTIFIER, Tokens.STRING, Tokens.NUMBER -> /*LL1AltBlock*/ {
                ...
                }Tokens.T__3, Tokens.T__4 -> /*LL1AltBlock*/ {
    ...
    public open class ExternalConstantTermContext : TermContext {
        public fun externalConstant(): ExternalConstantContext = getRuleContext(ExternalConstantContext::class, 0)!!
    ...
    public fun term(): TermContext {
        ...
        try {
            ...
            when (_input.LA(1)) {
                Tokens.T__10, Tokens.T__11, Tokens.T__21, Tokens.T__22, Tokens.T__34, Tokens.T__35, Tokens.T__36, Tokens.IDENTIFIER, Tokens.DELIMITEDIDENTIFIER -> /*LL1AltBlock*/ {
                    _localctx = InvocationTermContext(_localctx)
                    enterOuterAlt(_localctx, 1)
                    this.state = 77
                    invocation()

                }Tokens.T__29, Tokens.T__31, Tokens.T__32, Tokens.DATE, Tokens.DATETIME, Tokens.TIME, Tokens.STRING, Tokens.NUMBER -> /*LL1AltBlock*/ {
    ...
    public fun externalConstant(): ExternalConstantContext {
        ...
        try {
            ...
            when (_input.LA(1)) {
                Tokens.T__10, Tokens.T__11, Tokens.T__21, Tokens.T__22, Tokens.IDENTIFIER, Tokens.DELIMITEDIDENTIFIER -> /*LL1AltBlock*/ {
                    this.state = 98
                    identifier()
    ...
    public open class UnitContext : ParserRuleContext {
        ...
        public fun dateTimePrecision(): DateTimePrecisionContext? = getRuleContext(DateTimePrecisionContext::class, 0)
        public fun pluralDateTimePrecision(): PluralDateTimePrecisionContext? = getRuleContext(PluralDateTimePrecisionContext::class, 0)
        public fun STRING(): TerminalNode? = getToken(Tokens.STRING, 0)
    ...
    public fun unit(): UnitContext {
        ...
        try {
            ...
            when (_input.LA(1)) {
                Tokens.T__38, Tokens.T__39, Tokens.T__40, Tokens.T__41, Tokens.T__42, Tokens.T__43, Tokens.T__44, Tokens.T__45 -> /*LL1AltBlock*/ {
                    enterOuterAlt(_localctx, 1)
                    this.state = 128
                    dateTimePrecision()

                }Tokens.T__46, Tokens.T__47, Tokens.T__48, Tokens.T__49, Tokens.T__50, Tokens.T__51, Tokens.T__52, Tokens.T__53 -> /*LL1AltBlock*/ {
                    enterOuterAlt(_localctx, 2)
                    this.state = 129
    ...
    public open class TypeSpecifierContext : ParserRuleContext {
        ...
        public fun qualifiedIdentifier(): QualifiedIdentifierContext = getRuleContext(QualifiedIdentifierContext::class, 0)!!
