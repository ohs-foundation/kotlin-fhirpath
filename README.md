...
| `testFHIRPathIsFunction8`            | Implementation     |     |                                                        | Function `extension` is not implemented.                                                                                                                                |
| `testFHIRPathIsFunction9`            | Implementation     |     |                                                        | As above.                                                                                                                                                               |
| `testFHIRPathIsFunction10`           | Implementation     |     |                                                        | As above.                                                                                                                                                               |
