...
internal fun Distance.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
...
internal fun Distance.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "value" -> true
  "comparator" -> true
...
internal fun Distance.getAllChildren(): List<Any> = buildList {
