...
internal fun R4List.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "meta" -> this.meta
...
internal fun R4List.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "meta" -> true
    "implicitRules" -> true
...
internal fun R4List.Entry.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun R4List.Entry.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
