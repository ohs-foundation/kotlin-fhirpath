...
internal fun Element.getProperty(name: KotlinString): Any? = when(this) {
...
internal fun Element.hasProperty(name: KotlinString): KotlinBoolean = when(this) {
...
internal fun Element.getAllChildren(): List<Any> = when(this) {
