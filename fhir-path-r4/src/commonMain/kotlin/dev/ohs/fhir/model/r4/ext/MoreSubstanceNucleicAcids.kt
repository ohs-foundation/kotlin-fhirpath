...
internal fun SubstanceNucleicAcid.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
...
internal fun SubstanceNucleicAcid.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun SubstanceNucleicAcid.Subunit.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "subunit" -> this.subunit
...
internal fun SubstanceNucleicAcid.Subunit.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "subunit" -> true
...
internal fun SubstanceNucleicAcid.Subunit.Linkage.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun SubstanceNucleicAcid.Subunit.Linkage.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "connectivity" -> true
...
internal fun SubstanceNucleicAcid.Subunit.Sugar.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "identifier" -> this.identifier
...
internal fun SubstanceNucleicAcid.Subunit.Sugar.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "identifier" -> true
