...
internal fun Resource.getFhirType(): FhirR4Type? = when(this) {
  ...
  is MedicinalProductUndesirableEffect -> FhirR4ResourceType(ResourceType.MedicinalProductUndesirableEffect)
  ...
  is MedicinalProductPharmaceutical -> FhirR4ResourceType(ResourceType.MedicinalProductPharmaceutical)
  ...
  is SubstanceReferenceInformation -> FhirR4ResourceType(ResourceType.SubstanceReferenceInformation)
  ...
  is MedicinalProductContraindication -> FhirR4ResourceType(ResourceType.MedicinalProductContraindication)
  ...
  is MedicinalProductAuthorization -> FhirR4ResourceType(ResourceType.MedicinalProductAuthorization)
  is AdverseEvent -> FhirR4ResourceType(ResourceType.AdverseEvent)
  else -> null
}

internal fun Resource.getProperty(name: String): Any? = when(this) {
...
internal fun Resource.hasProperty(name: String): Boolean = when(this) {
...
internal fun Resource.getAllChildren(): CollectionsList<Any> = when(this) {
