...
private fun Any.getPropertyInChoiceValue0(name: String): Any? = when(this) {
  ...
  is SubstanceSpecification.Property.DefiningSubstance.CodeableConcept -> this.value.getProperty(name)
...
private fun Any.getPropertyInChoiceValue1(name: String): Any? = when(this) {
  ...
  is MedicinalProduct.SpecialDesignation.Indication.CodeableConcept -> this.value.getProperty(name)
  ...
  is MedicinalProductIndication.OtherTherapy.Medication.CodeableConcept -> this.value.getProperty(name)
...
private fun Any.getPropertyInChoiceValue4(name: String): Any? = when(this) {
  ...
  is MedicinalProductContraindication.OtherTherapy.Medication.CodeableConcept -> this.value.getProperty(name)
  is MedicinalProductContraindication.OtherTherapy.Medication.Reference -> this.value.getProperty(name)
...
private fun Any.hasPropertyInChoiceValue0(name: String): Boolean = when(this) {
  ...
  is SubstanceSpecification.Property.DefiningSubstance.CodeableConcept -> this.value.hasProperty(name)
...
private fun Any.hasPropertyInChoiceValue1(name: String): Boolean = when(this) {
  ...
  is MedicinalProduct.SpecialDesignation.Indication.CodeableConcept -> this.value.hasProperty(name)
  ...
  is MedicinalProductIndication.OtherTherapy.Medication.CodeableConcept -> this.value.hasProperty(name)
...
private fun Any.hasPropertyInChoiceValue4(name: String): Boolean = when(this) {
  ...
  is MedicinalProductContraindication.OtherTherapy.Medication.CodeableConcept -> this.value.hasProperty(name)
  is MedicinalProductContraindication.OtherTherapy.Medication.Reference -> this.value.hasProperty(name)
