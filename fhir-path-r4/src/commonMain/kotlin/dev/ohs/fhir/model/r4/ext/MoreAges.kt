...
internal fun Age.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
...
internal fun Age.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "value" -> true
  "comparator" -> true
...
internal fun Age.getAllChildren(): List<Any> = buildList {
