...
internal fun SubstanceAmount.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
...
internal fun SubstanceAmount.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
...
internal fun SubstanceAmount.ReferenceRange.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
...
internal fun SubstanceAmount.ReferenceRange.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "lowLimit" -> true
  "highLimit" -> true
