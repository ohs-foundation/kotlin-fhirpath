...
internal fun QuestionnaireResponse.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
...
internal fun QuestionnaireResponse.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun QuestionnaireResponse.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.questionnaire?.let { add(it) }
...
internal fun QuestionnaireResponse.Item.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "linkId" -> this.linkId
...
internal fun QuestionnaireResponse.Item.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "linkId" -> true
...
internal fun QuestionnaireResponse.Item.Answer.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "value" -> this.`value`
...
internal fun QuestionnaireResponse.Item.Answer.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "value" -> true
