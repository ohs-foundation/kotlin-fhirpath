...
internal fun DataRequirement.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
...
internal fun DataRequirement.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "type" -> true
  "profile" -> true
...
internal fun DataRequirement.CodeFilter.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "path" -> this.path
...
internal fun DataRequirement.CodeFilter.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "path" -> true
  "searchParam" -> true
...
internal fun DataRequirement.DateFilter.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "path" -> this.path
  "searchParam" -> this.searchParam
...
internal fun DataRequirement.DateFilter.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "path" -> true
  "searchParam" -> true
...
internal fun DataRequirement.Sort.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "path" -> this.path
...
internal fun DataRequirement.Sort.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "path" -> true
  "direction" -> true
