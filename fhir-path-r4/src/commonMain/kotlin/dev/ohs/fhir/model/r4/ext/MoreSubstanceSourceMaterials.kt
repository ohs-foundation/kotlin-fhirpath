...
internal fun SubstanceSourceMaterial.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
...
internal fun SubstanceSourceMaterial.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun SubstanceSourceMaterial.FractionDescription.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun SubstanceSourceMaterial.FractionDescription.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "fraction" -> true
...
internal fun SubstanceSourceMaterial.Organism.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "family" -> this.family
...
internal fun SubstanceSourceMaterial.Organism.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "family" -> true
...
internal fun SubstanceSourceMaterial.Organism.Author.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun SubstanceSourceMaterial.Organism.Author.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "authorType" -> true
...
internal fun SubstanceSourceMaterial.Organism.Hybrid.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun SubstanceSourceMaterial.Organism.Hybrid.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
...
internal fun SubstanceSourceMaterial.Organism.OrganismGeneral.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun SubstanceSourceMaterial.Organism.OrganismGeneral.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "kingdom" -> true
...
internal fun SubstanceSourceMaterial.Organism.OrganismGeneral.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
...
internal fun SubstanceSourceMaterial.PartDescription.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "part" -> this.part
...
internal fun SubstanceSourceMaterial.PartDescription.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "part" -> true
