...
internal fun Evidence.getProperty(name: String): Any? = when(name) {
  ...
  "exposureBackground" -> this.exposureBackground
  "exposureVariant" -> this.exposureVariant
...
internal fun Evidence.getAllChildren(): List<Any> = buildList {
  ...
  add(this@getAllChildren.exposureBackground)
  addAll(this@getAllChildren.exposureVariant)
