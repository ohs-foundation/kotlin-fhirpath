...
internal fun Dosage.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
...
internal fun Dosage.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
...
internal fun Dosage.DoseAndRate.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "type" -> this.type
  "dose" -> this.dose
...
internal fun Dosage.DoseAndRate.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "type" -> true
  "dose" -> true
