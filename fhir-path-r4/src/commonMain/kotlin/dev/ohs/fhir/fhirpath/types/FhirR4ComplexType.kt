...
public enum class FhirR4ComplexType(
  ...
  public companion object {
    public fun fromString(`value`: String): FhirR4ComplexType? = entries.find { it.typeName == value }

    public fun fromObject(`value`: Any): FhirR4ComplexType? = when (value) {
