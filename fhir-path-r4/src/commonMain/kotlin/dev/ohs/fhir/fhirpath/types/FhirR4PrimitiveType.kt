...
public enum class FhirR4PrimitiveType(
  ...
  public companion object {
    public fun fromString(`value`: kotlin.String): FhirR4PrimitiveType? = entries.find { it.typeName == value }

    public fun fromObject(`value`: Any): FhirR4PrimitiveType? = when (value) {
