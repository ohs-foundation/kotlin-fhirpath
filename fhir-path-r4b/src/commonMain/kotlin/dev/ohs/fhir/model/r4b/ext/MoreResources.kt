...
internal fun Resource.getFhirType(): FhirR4BType? = when(this) {
  ...
  is AdministrableProductDefinition -> FhirR4BResourceType(ResourceType.AdministrableProductDefinition)
