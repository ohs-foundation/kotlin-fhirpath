...
internal fun ImmunizationRecommendation.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
...
internal fun ImmunizationRecommendation.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun ImmunizationRecommendation.Recommendation.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun ImmunizationRecommendation.Recommendation.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "vaccineCode" -> true
...
internal fun ImmunizationRecommendation.Recommendation.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.targetDisease?.let { add(it) }
...
internal fun ImmunizationRecommendation.Recommendation.DateCriterion.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "code" -> this.code
...
internal fun ImmunizationRecommendation.Recommendation.DateCriterion.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "code" -> true
...
internal fun ImmunizationRecommendation.Recommendation.DateCriterion.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
