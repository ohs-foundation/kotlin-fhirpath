...
private fun Any.getPropertyInChoiceValue0(name: String): Any? = when(this) {
  ...
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed.UnsignedInt -> this.value.getProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed.String -> this.value.getProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed.Money -> this.value.getProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Used.UnsignedInt -> this.value.getProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Used.String -> this.value.getProperty(name)
...
private fun Any.getPropertyInChoiceValue1(name: String): Any? = when(this) {
  ...
  is SubstanceDefinition.Relationship.SubstanceDefinition.Reference -> this.value.getProperty(name)
  is SubstanceDefinition.Relationship.SubstanceDefinition.CodeableConcept -> this.value.getProperty(name)
  ...
  is ExplanationOfBenefit.BenefitBalance.Financial.Allowed.UnsignedInt -> this.value.getProperty(name)
  ...
  is ExplanationOfBenefit.BenefitBalance.Financial.Used.UnsignedInt -> this.value.getProperty(name)
  is ExplanationOfBenefit.BenefitBalance.Financial.Used.Money -> this.value.getProperty(name)
  is PackagedProductDefinition.Package.ShelfLifeStorage.Period.Duration -> this.value.getProperty(name)
  is PackagedProductDefinition.Package.ShelfLifeStorage.Period.String -> this.value.getProperty(name)
  is PackagedProductDefinition.Package.Property.Value.CodeableConcept -> this.value.getProperty(name)
...
private fun Any.getPropertyInChoiceValue2(name: String): Any? = when(this) {
  ...
  is ResearchElementDefinition.Characteristic.Definition.CodeableConcept -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.Definition.Canonical -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.Definition.Expression -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.Definition.DataRequirement -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.DateTime -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.Period -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.Duration -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.Timing -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.DateTime -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.Period -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.Duration -> this.value.getProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.Timing -> this.value.getProperty(name)
  ...
  is ClinicalUseDefinition.Interaction.Interactant.Item.CodeableConcept -> this.value.getProperty(name)
  is SpecimenDefinition.TypeTested.Container.MinimumVolume.Quantity -> this.value.getProperty(name)
  is SpecimenDefinition.TypeTested.Container.MinimumVolume.String -> this.value.getProperty(name)
  is SpecimenDefinition.TypeTested.Container.Additive.Additive.CodeableConcept -> this.value.getProperty(name)
  is SpecimenDefinition.TypeTested.Container.Additive.Additive.Reference -> this.value.getProperty(name)
  ...
  is CoverageEligibilityRequest.Item.Diagnosis.Diagnosis.CodeableConcept -> this.value.getProperty(name)
...
private fun Any.getPropertyInChoiceValue3(name: String): Any? = when(this) {
  ...
  is ImmunizationRecommendation.Recommendation.DoseNumber.PositiveInt -> this.value.getProperty(name)
  is ImmunizationRecommendation.Recommendation.DoseNumber.String -> this.value.getProperty(name)
  is ImmunizationRecommendation.Recommendation.SeriesDoses.PositiveInt -> this.value.getProperty(name)
  ...
  is MedicationKnowledge.AdministrationGuidelines.Indication.CodeableConcept -> this.value.getProperty(name)
  is MedicationKnowledge.AdministrationGuidelines.Indication.Reference -> this.value.getProperty(name)
  is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.CodeableConcept -> this.value.getProperty(name)
  is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.Quantity -> this.value.getProperty(name)
  ...
  is MedicinalProductDefinition.Characteristic.Value.CodeableConcept -> this.value.getProperty(name)
  ...
  is StructureMap.Group.Rule.Source.DefaultValue.ParameterDefinition -> this.value.getProperty(name)
...
private fun Any.getPropertyInChoiceValue4(name: String): Any? = when(this) {
  ...
  is Ingredient.Substance.Strength.ReferenceStrength.Strength.Ratio -> this.value.getProperty(name)
  is Ingredient.Substance.Strength.ReferenceStrength.Strength.RatioRange -> this.value.getProperty(name)
...
internal fun Any.getPropertyInChoiceValue(name: String): Any? {
  getPropertyInChoiceValue0(name)?.let { return it }
  getPropertyInChoiceValue1(name)?.let { return it }
  getPropertyInChoiceValue2(name)?.let { return it }
  getPropertyInChoiceValue3(name)?.let { return it }
  getPropertyInChoiceValue4(name)?.let { return it }
  return null
}

private fun Any.hasPropertyInChoiceValue0(name: String): Boolean = when(this) {
  ...
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed.UnsignedInt -> this.value.hasProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed.String -> this.value.hasProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Allowed.Money -> this.value.hasProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Used.UnsignedInt -> this.value.hasProperty(name)
  is CoverageEligibilityResponse.Insurance.Item.Benefit.Used.String -> this.value.hasProperty(name)
...
private fun Any.hasPropertyInChoiceValue1(name: String): Boolean = when(this) {
  ...
  is SubstanceDefinition.Relationship.SubstanceDefinition.Reference -> this.value.hasProperty(name)
  is SubstanceDefinition.Relationship.SubstanceDefinition.CodeableConcept -> this.value.hasProperty(name)
  ...
  is ExplanationOfBenefit.BenefitBalance.Financial.Allowed.UnsignedInt -> this.value.hasProperty(name)
  ...
  is ExplanationOfBenefit.BenefitBalance.Financial.Used.UnsignedInt -> this.value.hasProperty(name)
  is ExplanationOfBenefit.BenefitBalance.Financial.Used.Money -> this.value.hasProperty(name)
  is PackagedProductDefinition.Package.ShelfLifeStorage.Period.Duration -> this.value.hasProperty(name)
  is PackagedProductDefinition.Package.ShelfLifeStorage.Period.String -> this.value.hasProperty(name)
  is PackagedProductDefinition.Package.Property.Value.CodeableConcept -> this.value.hasProperty(name)
...
private fun Any.hasPropertyInChoiceValue2(name: String): Boolean = when(this) {
  ...
  is ResearchElementDefinition.Characteristic.Definition.CodeableConcept -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.Definition.Canonical -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.Definition.Expression -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.Definition.DataRequirement -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.DateTime -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.Period -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.Duration -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.StudyEffective.Timing -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.DateTime -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.Period -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.Duration -> this.value.hasProperty(name)
  is ResearchElementDefinition.Characteristic.ParticipantEffective.Timing -> this.value.hasProperty(name)
  ...
  is ClinicalUseDefinition.Interaction.Interactant.Item.CodeableConcept -> this.value.hasProperty(name)
  is SpecimenDefinition.TypeTested.Container.MinimumVolume.Quantity -> this.value.hasProperty(name)
  is SpecimenDefinition.TypeTested.Container.MinimumVolume.String -> this.value.hasProperty(name)
  is SpecimenDefinition.TypeTested.Container.Additive.Additive.CodeableConcept -> this.value.hasProperty(name)
  is SpecimenDefinition.TypeTested.Container.Additive.Additive.Reference -> this.value.hasProperty(name)
  ...
  is CoverageEligibilityRequest.Item.Diagnosis.Diagnosis.CodeableConcept -> this.value.hasProperty(name)
...
private fun Any.hasPropertyInChoiceValue3(name: String): Boolean = when(this) {
  ...
  is ImmunizationRecommendation.Recommendation.DoseNumber.PositiveInt -> this.value.hasProperty(name)
  is ImmunizationRecommendation.Recommendation.DoseNumber.String -> this.value.hasProperty(name)
  is ImmunizationRecommendation.Recommendation.SeriesDoses.PositiveInt -> this.value.hasProperty(name)
  ...
  is MedicationKnowledge.AdministrationGuidelines.Indication.CodeableConcept -> this.value.hasProperty(name)
  is MedicationKnowledge.AdministrationGuidelines.Indication.Reference -> this.value.hasProperty(name)
  is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.CodeableConcept -> this.value.hasProperty(name)
  is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.Quantity -> this.value.hasProperty(name)
  ...
  is MedicinalProductDefinition.Characteristic.Value.CodeableConcept -> this.value.hasProperty(name)
  ...
  is StructureMap.Group.Rule.Source.DefaultValue.ParameterDefinition -> this.value.hasProperty(name)
...
private fun Any.hasPropertyInChoiceValue4(name: String): Boolean = when(this) {
  ...
  is Ingredient.Substance.Strength.ReferenceStrength.Strength.Ratio -> this.value.hasProperty(name)
  is Ingredient.Substance.Strength.ReferenceStrength.Strength.RatioRange -> this.value.hasProperty(name)
...
private fun Any.unwrapChoiceValue0(): Any? = when(this) {
...
private fun Any.unwrapChoiceValue1(): Any? = when(this) {
...
private fun Any.unwrapChoiceValue2(): Any? = when(this) {
...
private fun Any.unwrapChoiceValue3(): Any? = when(this) {
  ...
  is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.CodeableConcept -> this.value
  is MedicationKnowledge.AdministrationGuidelines.PatientCharacteristics.Characteristic.Quantity -> this.value
...
private fun Any.unwrapChoiceValue4(): Any? = when(this) {
...
internal fun Any.unwrapChoiceValue(): Any? {
  unwrapChoiceValue0()?.let { return it }
  unwrapChoiceValue1()?.let { return it }
  unwrapChoiceValue2()?.let { return it }
  unwrapChoiceValue3()?.let { return it }
  unwrapChoiceValue4()?.let { return it }
  return null
}
