...
public enum class FhirR4BPrimitiveType(
  ...
  public companion object {
    public fun fromString(`value`: kotlin.String): FhirR4BPrimitiveType? = entries.find { it.typeName == value }

    public fun fromObject(`value`: Any): FhirR4BPrimitiveType? = when (value) {
