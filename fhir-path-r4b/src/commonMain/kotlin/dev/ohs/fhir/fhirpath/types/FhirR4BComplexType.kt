...
public enum class FhirR4BComplexType(
  ...
  public companion object {
    public fun fromString(`value`: String): FhirR4BComplexType? = entries.find { it.typeName == value }

    public fun fromObject(`value`: Any): FhirR4BComplexType? = when (value) {
