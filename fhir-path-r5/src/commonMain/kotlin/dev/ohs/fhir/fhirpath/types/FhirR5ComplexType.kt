...
public enum class FhirR5ComplexType(
  ...
  public companion object {
    public fun fromString(`value`: String): FhirR5ComplexType? = entries.find { it.typeName == value }

    public fun fromObject(`value`: Any): FhirR5ComplexType? = when (value) {
