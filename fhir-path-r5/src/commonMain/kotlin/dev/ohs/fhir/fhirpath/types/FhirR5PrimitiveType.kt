...
public enum class FhirR5PrimitiveType(
  ...
  public companion object {
    public fun fromString(`value`: kotlin.String): FhirR5PrimitiveType? = entries.find { it.typeName == value }

    public fun fromObject(`value`: Any): FhirR5PrimitiveType? = when (value) {
