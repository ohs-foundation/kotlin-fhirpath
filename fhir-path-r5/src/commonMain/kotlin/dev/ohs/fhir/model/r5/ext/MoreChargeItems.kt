...
internal fun ChargeItem.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
  ...
  "unitPriceComponent" -> this.unitPriceComponent
...
internal fun ChargeItem.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun ChargeItem.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.unitPriceComponent?.let { add(it) }
  this@getAllChildren.totalPriceComponent?.let { add(it) }
...
internal fun ChargeItem.Performer.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun ChargeItem.Performer.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "function" -> true
