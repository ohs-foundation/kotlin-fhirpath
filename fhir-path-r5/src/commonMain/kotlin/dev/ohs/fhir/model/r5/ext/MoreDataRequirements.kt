...
internal fun DataRequirement.getAllChildren(): List<Any> = buildList {
  ...
  addAll(this@getAllChildren.valueFilter)
...
internal fun DataRequirement.ValueFilter.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "path" -> this.path
...
internal fun DataRequirement.ValueFilter.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "path" -> true
...
internal fun DataRequirement.ValueFilter.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  this@getAllChildren.path?.let { add(it) }
  this@getAllChildren.searchParam?.let { add(it) }
