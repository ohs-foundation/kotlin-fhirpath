...
internal fun Coverage.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.insurancePlan?.let { add(it) }
}

internal fun Coverage.PaymentBy.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun Coverage.PaymentBy.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun Coverage.PaymentBy.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
  add(this@getAllChildren.party)
  this@getAllChildren.responsibility?.let { add(it) }
}
