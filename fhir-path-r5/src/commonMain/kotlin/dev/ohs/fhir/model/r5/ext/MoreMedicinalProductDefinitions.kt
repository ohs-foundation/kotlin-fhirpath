...
internal fun MedicinalProductDefinition.getAllChildren(): List<Any> = buildList {
  ...
  addAll(this@getAllChildren.comprisedOf)
...
internal fun MedicinalProductDefinition.Name.Part.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun MedicinalProductDefinition.Name.Part.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun MedicinalProductDefinition.Name.Part.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
...
internal fun MedicinalProductDefinition.Name.Usage.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun MedicinalProductDefinition.Name.Usage.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun MedicinalProductDefinition.Name.Usage.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
