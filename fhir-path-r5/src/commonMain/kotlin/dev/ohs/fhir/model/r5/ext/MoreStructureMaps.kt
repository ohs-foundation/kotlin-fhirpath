...
internal fun StructureMap.getAllChildren(): List<Any> = buildList {
  ...
  addAll(this@getAllChildren.`const`)
...
internal fun StructureMap.Const.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun StructureMap.Const.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun StructureMap.Const.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
...
internal fun StructureMap.Group.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.typeMode?.let { add(it) }
  this@getAllChildren.documentation?.let { add(it) }
