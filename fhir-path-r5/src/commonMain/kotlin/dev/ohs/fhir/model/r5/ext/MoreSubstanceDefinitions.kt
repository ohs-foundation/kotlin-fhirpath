...
internal fun SubstanceDefinition.getAllChildren(): List<Any> = buildList {
  ...
  addAll(this@getAllChildren.characterization)
...
internal fun SubstanceDefinition.Characterization.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun SubstanceDefinition.Characterization.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun SubstanceDefinition.Characterization.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
  this@getAllChildren.technique?.let { add(it) }
  this@getAllChildren.form?.let { add(it) }
  this@getAllChildren.description?.let { add(it) }
  addAll(this@getAllChildren.`file`)
}
