...
internal fun ActorDefinition.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
...
internal fun ActorDefinition.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun ActorDefinition.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.capabilities?.let { add(it) }
