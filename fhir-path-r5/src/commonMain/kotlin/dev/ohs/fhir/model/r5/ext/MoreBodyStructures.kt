...
internal fun BodyStructure.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
...
internal fun BodyStructure.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun BodyStructure.IncludedStructure.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun BodyStructure.IncludedStructure.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "structure" -> true
...
internal fun BodyStructure.IncludedStructure.BodyLandmarkOrientation.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun BodyStructure.IncludedStructure.BodyLandmarkOrientation.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
...
internal fun BodyStructure.IncludedStructure.BodyLandmarkOrientation.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
...
internal fun BodyStructure.IncludedStructure.BodyLandmarkOrientation.DistanceFromLandmark.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "device" -> this.device
...
internal fun BodyStructure.IncludedStructure.BodyLandmarkOrientation.DistanceFromLandmark.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "device" -> true
...
internal fun BodyStructure.IncludedStructure.BodyLandmarkOrientation.DistanceFromLandmark.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
