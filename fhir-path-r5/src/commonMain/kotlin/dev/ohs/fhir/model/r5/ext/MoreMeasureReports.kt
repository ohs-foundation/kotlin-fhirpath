...
internal fun MeasureReport.getProperty(name: String): Any? =
  when (name) {
    ...
    "status" -> this.status
    "type" -> this.type
    "dataUpdateType" -> this.dataUpdateType
    "measure" -> this.measure
    "subject" -> this.subject
    "date" -> this.date
    "reporter" -> this.reporter
    "reportingVendor" -> this.reportingVendor
...
internal fun MeasureReport.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.dataUpdateType?.let { add(it) }
  ...
  this@getAllChildren.reportingVendor?.let { add(it) }
  this@getAllChildren.location?.let { add(it) }
  add(this@getAllChildren.period)
  this@getAllChildren.inputParameters?.let { add(it) }
...
internal fun MeasureReport.Group.Population.getProperty(name: String): Any? =
  when (name) {
    ...
    "subjectReport" -> this.subjectReport
...
internal fun MeasureReport.Group.Population.getAllChildren(): List<Any> = buildList {
  ...
  addAll(this@getAllChildren.subjectReport)
  this@getAllChildren.subjects?.let { add(it) }
}
