...
internal fun Appointment.RecurrenceTemplate.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun Appointment.RecurrenceTemplate.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "timezone" -> true
...
internal fun Appointment.RecurrenceTemplate.WeeklyTemplate.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "monday" -> this.monday
...
internal fun Appointment.RecurrenceTemplate.WeeklyTemplate.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "monday" -> true
...
internal fun Appointment.RecurrenceTemplate.MonthlyTemplate.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun Appointment.RecurrenceTemplate.MonthlyTemplate.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "dayOfMonth" -> true
...
internal fun Appointment.RecurrenceTemplate.MonthlyTemplate.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
...
internal fun Appointment.RecurrenceTemplate.YearlyTemplate.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
...
internal fun Appointment.RecurrenceTemplate.YearlyTemplate.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "yearInterval" -> true
