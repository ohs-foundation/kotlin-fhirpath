...
internal fun Endpoint.getAllChildren(): List<Any> = buildList {
  ...
  addAll(this@getAllChildren.connectionType)
  this@getAllChildren.name?.let { add(it) }
  this@getAllChildren.description?.let { add(it) }
  addAll(this@getAllChildren.environmentType)
...
internal fun Endpoint.Payload.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun Endpoint.Payload.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun Endpoint.Payload.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
  addAll(this@getAllChildren.type)
  addAll(this@getAllChildren.mimeType)
}
