...
internal fun Requirements.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "meta" -> this.meta
...
internal fun Requirements.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "meta" -> true
    "implicitRules" -> true
...
internal fun Requirements.getAllChildren(): List<Any> = buildList {
  ...
  addAll(this@getAllChildren.statement)
}

internal fun Requirements.Statement.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
    ...
    "conditionality" -> this.conditionality
...
internal fun Requirements.Statement.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun Requirements.Statement.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
  add(this@getAllChildren.key)
  this@getAllChildren.label?.let { add(it) }
  addAll(this@getAllChildren.conformance)
  this@getAllChildren.conditionality?.let { add(it) }
  add(this@getAllChildren.requirement)
  this@getAllChildren.derivedFrom?.let { add(it) }
  this@getAllChildren.parent?.let { add(it) }
  addAll(this@getAllChildren.satisfiedBy)
  addAll(this@getAllChildren.reference)
