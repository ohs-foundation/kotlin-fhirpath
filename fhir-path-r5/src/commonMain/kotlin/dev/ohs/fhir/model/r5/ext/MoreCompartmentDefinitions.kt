...
internal fun CompartmentDefinition.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "meta" -> this.meta
...
internal fun CompartmentDefinition.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "meta" -> true
  "implicitRules" -> true
  "language" -> true
...
internal fun CompartmentDefinition.Resource.getProperty(name: String): Any? = when(name) {
  "id" -> this.id
  "extension" -> this.extension
  "modifierExtension" -> this.modifierExtension
  "code" -> this.code
...
internal fun CompartmentDefinition.Resource.hasProperty(name: String): Boolean = when(name) {
  "id" -> true
  "extension" -> true
  "modifierExtension" -> true
  "code" -> true
...
internal fun CompartmentDefinition.Resource.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.startParam?.let { add(it) }
  this@getAllChildren.endParam?.let { add(it) }
}
