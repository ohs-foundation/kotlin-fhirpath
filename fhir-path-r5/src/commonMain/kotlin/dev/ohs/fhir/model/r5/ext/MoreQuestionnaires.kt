...
internal fun Questionnaire.Item.getProperty(name: String): Any? =
  when (name) {
    ...
    "disabledDisplay" -> this.disabledDisplay
    "required" -> this.required
    "repeats" -> this.repeats
    "readOnly" -> this.readOnly
    "maxLength" -> this.maxLength
    "answerConstraint" -> this.answerConstraint
...
internal fun Questionnaire.Item.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.disabledDisplay?.let { add(it) }
  ...
  this@getAllChildren.answerConstraint?.let { add(it) }
