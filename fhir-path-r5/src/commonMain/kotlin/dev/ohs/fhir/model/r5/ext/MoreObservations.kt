...
internal fun Observation.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.instantiates?.let { add(it) }
  addAll(this@getAllChildren.basedOn)
  addAll(this@getAllChildren.triggeredBy)
...
internal fun Observation.TriggeredBy.getProperty(name: String): Any? =
  when (name) {
    "id" -> this.id
    "extension" -> this.extension
    "modifierExtension" -> this.modifierExtension
...
internal fun Observation.TriggeredBy.hasProperty(name: String): Boolean =
  when (name) {
    "id" -> true
    "extension" -> true
    "modifierExtension" -> true
...
internal fun Observation.TriggeredBy.getAllChildren(): List<Any> = buildList {
  this@getAllChildren.id?.let { add(it) }
  addAll(this@getAllChildren.extension)
  addAll(this@getAllChildren.modifierExtension)
  add(this@getAllChildren.observation)
...
internal fun Observation.ReferenceRange.getAllChildren(): List<Any> = buildList {
  ...
  this@getAllChildren.normalValue?.let { add(it) }
